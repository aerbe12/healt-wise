        ...
        <main className={mainClass}>
          <div className={contentMaxClass}>
            ...
            <h1 className="mb-4 text-balance text-4xl leading-[1.08] font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
              ...
              {subtitle.trim() ? (
                <span className="mt-2 block max-w-3xl text-balance text-xl font-semibold tracking-tight text-white/90 sm:text-2xl md:text-3xl lg:text-[1.65rem] xl:max-w-4xl">
                  {subtitle}
                </span>
              ) : null}
            </h1>
            ...
            {showLiveCalendar ? (
              <p className="mt-4 inline-flex flex-wrap items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-4 py-2.5 text-sm font-medium text-white/95 backdrop-blur-sm">
                <Calendar
                  className="h-5 w-5 shrink-0 text-amber-200"
                  aria-hidden
                />
                <span className="text-amber-100/95">
                  {liveDateLabel ?? "Loading date…"}
                </span>
                <span className="text-white/80">· live UK date</span>
              </p>
            ) : null}
