...
export function DietFaqSection() {
  return (
    <section aria-labelledby="diet-faq-heading">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h2 id="diet-faq-heading" className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
          Frequently asked questions
        </h2>
        <p className="mt-3 text-base text-slate-600">
          Straight answers on deficits, carbs, medications, and common diet myths.
        </p>
