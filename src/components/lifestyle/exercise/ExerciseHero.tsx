...
import { EXERCISE_HERO_IMAGE } from "@/lib/lifestyle/exercise-content";
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 sm:py-20 md:gap-16 md:py-24 lg:grid-cols-2 lg:items-center lg:gap-20 lg:px-8">
        <div className="max-w-xl lg:max-w-none">
          ...
          <p className="mt-6 text-lg leading-relaxed text-slate-600 sm:text-xl">
            Understand how movement, strength, and consistency work together to burn fat, boost
            metabolism, and support long-term results.
          </p>
