...
export function StressFaqSection() {
  return (
    <section aria-labelledby="stress-faq-heading">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h2 id="stress-faq-heading" className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
