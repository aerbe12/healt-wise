  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex w-full items-center justify-center gap-1 rounded-lg px-1 py-1 text-left text-xs uppercase tracking-wide transition hover:bg-slate-200/60 hover:text-slate-900 data-[active=true]:text-violet-800"
        data-active={active}
      >
