...
const PAGE_TITLE =
  "Best Weight Loss Treatment Craigavon: Northern Ireland Options Explained";

export default function CraigavonLocationContent({ loc, shareUrl }: Props) {
  ...
  const toc = useMemo(
    () => [
      ...
      { id: "landscape", label: "Craigavon local weight loss landscape" },
      { id: "prescriptions", label: "Prescription paths in Craigavon area" },
      { id: "lifestyle", label: "Lifestyle boosters for Craigavon success" },
      { id: "alternatives", label: "Non drug alternatives near Craigavon" },
      { id: "pitfalls", label: "Pitfalls and realities" },
      { id: "resources", label: "Craigavon resources" },
      { id: "conclusion", label: "Conclusion: smart steps for Craigavon slimming" },
      { id: "sources", label: "Sources you can open in a second tab" },
      { id: "trust", label: "Why Health Wise is a comparator, not a prescriber" },
      { id: "next-steps", label: "Practical next steps (UK wide, including Craigavon)" },
    ...
    >
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-8 sm:px-6 sm:pt-10 md:pt-12 lg:px-8">
        ...
        <div className="flex flex-col gap-10 xl:flex-row xl:items-start xl:gap-16">
          {toc.length > 0 ? <GuideTocSidebar key="uk-loc-toc-craigavon" toc={toc} /> : null}

          <div className="min-w-0 flex-1 max-w-3xl">
            <article className="space-y-8 leading-relaxed">
              <GuideSection darkMode={darkMode} id="intro" heading={`Why best weight loss treatment in ${name} is personal`}>
                <p className={`text-lg md:text-xl ${p}`}>
                  Several private, doctor led, and pharmacy based weight loss treatments exist around Craigavon, emphasizing medical oversight, lifestyle changes, and prescriptions like Mounjaro (tirzepatide) or Wegovy (semaglutide), but always under professional guidance.
                </p>
                <p className={`text-lg md:text-xl ${p}`}>
                  Craigavon&apos;s lakeside calm near Lough Neagh contrasts busy factory shifts. Portadown markets or Lurgan takeaways add pounds easily.{" "}
                  <strong className={strong}>What defines the best weight loss treatment in Craigavon</strong>? Balanced medical and habit strategies, per experts.
                </p>
              </GuideSection>

              <GuideSection darkMode={darkMode} id="landscape" heading="Craigavon local weight loss landscape">
                <p className={p}>
                  NHS statistics peg Northern Ireland obesity around 29% in some dashboards, with industrial pace worsening it. For official tables see{" "}
                  <a
                  ...
                  . Commuter snacks can derail efforts.
                </p>
                <p className={p}>
              ...
              <GuideSection darkMode={darkMode} id="prescriptions" heading="Prescription paths in Craigavon area">
                <p className={`text-lg md:text-xl ${p}`}>
                  Weight loss injections like Wegovy are not routinely NHS funded in Northern Ireland; private or pharmacy routes via GP referral can cost about 150 to 300 pounds per month.
                </p>
                <p className={p}>
                  These medicines curb appetite and slow digestion. NICE approvals and eligibility criteria are described on the guidance page:{" "}
                  <a
                ...
                <p className={p}>
                  Mounjaro dual hormone action yields large average loss in trials. Lancet DOI{" "}
                  <a
                    href="https://doi.org/10.1016/S0140-6736(24)00567-8"
                    className={linkCls}
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    10.1016/S0140-6736(24)00567-8
                  </a>
                  . Ozempic is similar semaglutide and diabetes first.
                </p>
                <p className={p}>
                  Side effects include nausea and rare pancreatitis, so monitoring matters. Not quick fixes. JAMA warns rebound risk without habits.{" "}
                  <a
              ...
              <GuideSection darkMode={darkMode} id="lifestyle" heading="Lifestyle boosters for Craigavon success">
                <p className={p}>Medicines amplify basics.</p>
                <p className={p}>
                  Diet tweaks by the lough: 500 calorie deficits can support about 0.5 kg per week. NICE CG189 gives the UK baseline.{" "}
                  <a
                ...
                <p className={p}>
                  Fasting might aid shifts and some summaries cite about 4% loss. NEJM DOI{" "}
                  <a
                ...
                <p className={p}>
                  Moves around Craigavon: Lough walks can burn around 300 calories per hour depending on pace and body size. Aim near 150 minutes per week. WHO guidance:{" "}
                  <a
              ...
              <GuideSection darkMode={darkMode} id="alternatives" heading="Non drug alternatives near Craigavon">
                <p className={p}>
                  Cryolipolysis can reduce local fat thickness for selected candidates. Plastic Surgery DOI{" "}
                  <a
              ...
              <GuideSection darkMode={darkMode} id="pitfalls" heading="Pitfalls and realities">
                <p className={p}>
                  Plateaus are expected. Supplements are risky and MHRA warns about unregulated products.{" "}
                  <a
                ...
                <p className={p}>Surgery may be considered for very high BMI, typically above 40.</p>
              </GuideSection>

              <GuideSection darkMode={darkMode} id="resources" heading="Craigavon resources">
                <p className={p}>Lough trails, markets, and apps for tracking.</p>
              </GuideSection>

              <GuideSection darkMode={darkMode} id="conclusion" heading="Conclusion: smart steps for Craigavon slimming">
                <p className={p}>
                  Best weight loss treatment Craigavon? Doctor guided medicines like Mounjaro and Wegovy plus local habits. Consult professionals and empower your lough side glow.
                </p>
              </GuideSection>
              ...
              <section id="trust" className={`scroll-mt-28 rounded-xl border p-5 ${border} ${boxBg}`}>
                ...
                <div className={`mt-4 space-y-3 text-sm ${p}`}>
                  <p>
                    We compare prices and packaging, not your blood tests. Treat this Craigavon page as orientation, not a consultation.
                  </p>
                  <p className={muted}>
                    How we work{" "}
              ...
              <GuideSection darkMode={darkMode} id="next-steps" heading="Practical next steps (UK wide, including Craigavon)">
            ...
            <div className="mt-14">
              <GuideSharePanel
                url={shareUrl}
                title={PAGE_TITLE}
                description="Craigavon Northern Ireland: doctor led options, GLP 1 medicines, and safe UK comparisons for weight loss treatments."
              />
            </div>
          </div>
        </div>
