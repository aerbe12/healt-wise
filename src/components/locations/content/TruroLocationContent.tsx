...
export default function TruroLocationContent({ loc, shareUrl }: Props) {
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
        <p className="mb-6 rounded-lg bg-slate-50 p-4 border border-slate-200 text-slate-800 leading-relaxed"><strong className="text-slate-900">Weight Management in Truro:</strong> Navigating the intersection of England's public health resources and private clinical services can be daunting. For individuals in Truro considering prescription weight loss treatments, comparing online prescribers ensures you find a safe and properly regulated medical provider.</p>
      </div>
