    ...
    <div className="space-y-4">
      ...
      <div className={COMPARE_TABLE_MOBILE_OUTDENT_CLASS}>
        <div className="relative overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-sm max-lg:rounded-none max-lg:border-x-0">
          ...
          <div className="max-lg:max-h-none max-lg:min-h-0 max-lg:w-full max-lg:min-w-0 max-lg:overflow-x-auto max-lg:overflow-y-visible max-lg:overscroll-x-none lg:max-h-[min(78vh,640px)] lg:overflow-auto lg:overscroll-contain min-h-0 w-full min-w-0 [overflow-anchor:none]">
