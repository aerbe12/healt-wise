          ...
          <div className="mx-auto w-full max-w-4xl text-center lg:mx-0 lg:max-w-3xl lg:text-left">
            <GlassPill>
              <span className="inline-flex items-center gap-1.5">
                <Sparkles className="h-3.5 w-3.5 shrink-0 text-sky-200" aria-hidden />
            ...
            <h1 className="mb-4 text-balance text-4xl leading-[1.08] font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
              <span className={`${instrumentSerif.className} text-sky-100/95 italic`}>
                Compare
              </span>{" "}
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm font-light text-white/70 lg:justify-start">
              ...
              <span className="inline-flex items-center gap-2">
                <Sparkles
                  className="h-5 w-5 shrink-0 text-sky-200/90"
                  aria-hidden
                />
            ...
            <div className="mt-6 flex justify-center lg:justify-start">
              <Link
                href="/what-is-saxenda"
                className="inline-flex items-center gap-2 text-xs font-medium text-sky-200/90 underline-offset-4 transition hover:text-white hover:underline"
              >
                How Saxenda works
