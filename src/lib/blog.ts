...
export const CURATED_APP_ROUTER_POSTS: BlogPostMeta[] = [
  {
    ...
    date: '2026-04-25',
    category: 'Guides',
    description: 'Weekly weight loss injections in the UK explained: how Wegovy and Mounjaro may affect appetite, access (NHS vs private), side effects, and what happens after stopping.',
  ...
  },
  {
    ...
    date: '2026-04-25',
    category: 'Guides',
    description: "Explore uk prescription weight loss injections and discover if they're the safe, effective boost you need.",
  ...
  },
  {
    ...
    date: '2026-04-23',
    category: 'Guides',
    description: 'Stay ahead of weight loss injection shortages in the UK: what you need to know to reach your goals.',
  ...
  },
  {
    ...
    date: '2026-04-21',
    category: 'Guides',
    description: 'Get confident with understanding the mounjaro kwikpen: a user guide to your UK weight loss injection journey.',
