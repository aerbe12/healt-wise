...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/switching-pharmacies-mounjaro-wegovy-uk" },
};
...
const RELATED_GUIDES = [
  {
    href: "/local-vs-online-pharmacies-mounjaro-uk",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/switching-pharmacies-mounjaro-wegovy-uk",
  },
};
...
export default function GuideSwitchingPharmacy() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideSwitchingPharmacy")}
        ...
        <GuideBulletListRich
          items={[
            ...
            <>
              ...
              <IL href="/mounjaro-delivery-storage-uk">
            ...
            <>
              ...
              <IL href="/mounjaro-gp-notification-uk">
