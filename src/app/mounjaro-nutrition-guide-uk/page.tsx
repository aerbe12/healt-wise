...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-nutrition-guide-uk" },
};
...
const RELATED_GUIDES = [
  ...
  {
    href: "/mounjaro-early-weight-loss-why-it-slows",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-nutrition-guide-uk",
  },
};
...
export default function GuideMounjaroNutrition() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroNutrition")}
