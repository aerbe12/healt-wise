...
export const metadata: Metadata = {
  title:
    "Mounjaro Skin Pain Explained: Causes, Symptoms & How to Treat It | Health Wise",
  description:
    "Some Mounjaro users report skin sensitivity, burning, or pain from light touch. Here's what may be causing it—nerve sensitivity, nutritional changes, blood sugar shifts—and how to manage symptoms.",
  openGraph: {
  ...
  alternates: { canonical: "/mounjaro-skin-pain-causes-treatment" },
};
...
const REFERENCES = [
  ...
  },
  {
    ...
    href: "/mounjaro-multivitamins-uk",
    external: false,
  },
];
...
const RELATED_GUIDES = [
  ...
  {
    href: "/mounjaro-feeling-cold-why-fixes",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-skin-pain-causes-treatment",
  },
};
    ...
    >
      ...
      <GuideSection id="nutrition" heading="Nutritional Factors">
        ...
        <GuideCallout variant="tip">
          ...
          <IL href="/mounjaro-multivitamins-uk">
