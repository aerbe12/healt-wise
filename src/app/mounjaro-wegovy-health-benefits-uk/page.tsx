...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-wegovy-health-benefits-uk" },
};
...
const RELATED_GUIDES = [
  ...
  {
    href: "/switching-wegovy-to-mounjaro-uk",
    category: "Medications",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-wegovy-health-benefits-uk",
  },
};
...
export default function GuideMounjaroHealthBenefits() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroHealthBenefits")}
