...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/mounjaro-weight-loss-injection-uk",
  },
};
...
const RELATED_GUIDES = [
  {
    href: "/mounjaro-weight-loss-plateau",
  ...
  {
    href: "/mounjaro-pregnancy-risk-fertility-contraception",
    category: "Medications",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-weight-loss-injection-uk",
  },
};
    ...
    >
      ...
      <GuideSection id="eligibility" heading="Who Can Get Mounjaro in the UK?">
        ...
        <GuideParagraph>
          ...
          <IL href="/mounjaro-prescription-timeline-uk">
