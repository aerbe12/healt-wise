...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-side-effects-uk" },
};
...
const REFERENCES = [
  ...
  },
  {
    ...
    href: "/mounjaro-constipation-relief-uk",
    external: false,
  },
  {
    ...
    href: "/mounjaro-wegovy-health-benefits-uk",
    external: false,
  },
];
...
const RELATED_GUIDES = [
  ...
  {
    href: "/mounjaro-skin-pain-causes-treatment",
    category: "Side Effects",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-side-effects-uk",
  },
};
        ...
        <GuideBulletListRich
          items={[
            <>
              ...
              <IL href="/mounjaro-constipation-relief-uk">
