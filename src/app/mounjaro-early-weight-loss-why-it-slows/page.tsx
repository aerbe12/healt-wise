...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-early-weight-loss-why-it-slows" },
};
...
const REFERENCES = [
  ...
  },
  {
    ...
    href: "/mounjaro-calorie-cycling-weight-loss",
    external: false,
  },
];
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-early-weight-loss-why-it-slows",
  },
};
    ...
    >
      ...
      <GuideSection id="plateaus-normal" heading="Plateaus Are Normal">
        ...
        <GuideCallout variant="tip">
          ...
          <IL href="/mounjaro-weight-loss-plateau">
        ...
        <GuideBulletListRich
          items={[
            ...
            <>
              ...
              <IL href="/mounjaro-calorie-cycling-weight-loss">
