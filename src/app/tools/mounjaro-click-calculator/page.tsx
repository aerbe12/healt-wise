      ...
      <article className="relative z-20 border-t border-slate-200/80 bg-background">
        <div className="mx-auto max-w-3xl px-4 py-14 sm:px-5 md:px-8 md:py-20">
          ...
          <p className="mt-4 leading-relaxed text-slate-700">
            The UK Mounjaro KwikPen is designed as a multi-dose device that delivers exactly four full doses of the prescribed strength. A standard full dose is achieved by turning the dial until it stops, which corresponds to exactly <strong>60 clicks</strong>.
          </p>
          <p className="mt-4 leading-relaxed text-slate-700">
            This tool is provided for informational purposes, to help patients visually understand how the volume translates into clicks. Attempting to extract partial doses or &quot;split&quot; a pen is considered an <strong>off-label use</strong>. We strongly advise that you only follow the dosage prescribed by your healthcare provider and consult them before making any adjustments to your treatment plan.
          </p>
          ...
          <ul className="mt-3 list-inside list-disc space-y-2 text-slate-700">
            ...
            <li>
              <strong>Sterility and device mechanics:</strong> The KwikPen is built for a specific usage pattern. Reusing needles or manipulating the dial for partial doses may affect the sterility of the medication or the accuracy of the pen.
            </li>
            <li>
          ...
          <p className="mt-4 leading-relaxed text-slate-700">
            The math behind the click calculator is simple. Since a full dose is always 60 clicks, you divide your desired dose by the total pen strength, and then multiply by 60.
          </p>
          <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
            <p className="font-mono text-lg font-bold text-slate-900">
              Clicks = (Desired Dose ÷ Pen Strength) × 60
            </p>
          </div>
          <p className="mt-4 leading-relaxed text-slate-700">
