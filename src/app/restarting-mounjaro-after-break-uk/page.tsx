...
export const metadata: Metadata = {
  title:
    "Restarting Mounjaro After a Break: UK Guide (2026) | Health Wise",
  description:
    "Restarting Mounjaro after a gap is often possible—even if your BMI has dropped. Here's how break length affects your restart dose, what providers need, and how to do it safely.",
  openGraph: {
  ...
  alternates: { canonical: "/restarting-mounjaro-after-break-uk" },
};
...
const REFERENCES = [
  ...
  },
  {
    ...
    href: "/mounjaro-eligibility-bmi-requirements-uk",
    external: false,
  },
  {
    ...
    href: "/switching-pharmacies-mounjaro-wegovy-uk",
    external: false,
  },
];
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/restarting-mounjaro-after-break-uk",
  },
};
...
export default function GuideRestartingMounjaro() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideRestartingMounjaro")}
    ...
    >
      <GuideSection id="can-you-restart" heading="Can You Restart Mounjaro?">
        ...
        <GuideParagraph>
          ...
          <IL href="/mounjaro-eligibility-bmi-requirements-uk">
