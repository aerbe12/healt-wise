...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-feeling-cold-why-fixes" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-feeling-cold-why-fixes",
  },
};
...
export default function GuideMounjaroFeelCold() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroFeelCold")}
