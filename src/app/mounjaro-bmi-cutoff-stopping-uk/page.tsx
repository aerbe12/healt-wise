...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-bmi-cutoff-stopping-uk" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-bmi-cutoff-stopping-uk",
  },
};
...
export default function GuideMounjaroBMICutoff() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroBMICutoff")}
    ...
    >
      ...
      <GuideSection id="finding-provider" heading="Finding the Right Provider">
        ...
        <GuideParagraph>
          ...
          . See our guide on{" "}
          <IL href="/local-vs-online-pharmacies-mounjaro-uk">
