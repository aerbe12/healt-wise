...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/mounjaro-prescription-timeline-uk",
  },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-prescription-timeline-uk",
  },
};
...
export default function GuideMounjaroTimeline() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroTimeline")}
