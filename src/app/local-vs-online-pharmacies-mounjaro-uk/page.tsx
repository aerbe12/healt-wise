...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/local-vs-online-pharmacies-mounjaro-uk" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/local-vs-online-pharmacies-mounjaro-uk",
  },
};
...
export default function GuideLocalVsOnline() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideLocalVsOnline")}
