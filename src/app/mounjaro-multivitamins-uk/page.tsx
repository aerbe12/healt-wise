...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-multivitamins-uk" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-multivitamins-uk",
  },
};
...
export default function GuideMounjaroVitamins() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroVitamins")}
