...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/mounjaro-pregnancy-risk-fertility-contraception",
  },
};
...
const RELATED_GUIDES = [
  ...
  {
    href: "/glp1-content-removed-weight-loss-advice-uk",
    category: "Regulation",
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-pregnancy-risk-fertility-contraception",
  },
};
...
export default function GuideMounjaroPregnancy() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaro")}
