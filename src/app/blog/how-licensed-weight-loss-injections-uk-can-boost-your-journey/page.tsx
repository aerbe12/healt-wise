...
export const metadata: Metadata = {
  ...
  keywords: 'licensed weight loss treatments UK, Mounjaro, Wegovy, MHRA approved, prescription weight loss, obesity treatment UK, appetite control, clinical supervision',
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: HERO_IMAGE,
        alt: 'Licensed weight loss treatments in the UK help support regulated treatment and appetite control',
      },
    ],
  },
  twitter: {
