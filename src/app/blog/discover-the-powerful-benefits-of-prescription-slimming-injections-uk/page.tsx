...
export const metadata: Metadata = {
  ...
  keywords: 'prescription slimming injections UK, Wegovy, Mounjaro, Saxenda, GLP-1, prescription weight loss, obesity treatment UK, slimming injections benefits',
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: HERO_IMAGE,
        alt: 'Prescription slimming injections UK with Wegovy, Mounjaro and Saxenda for regulated obesity treatment',
      },
    ],
  },
  twitter: {
