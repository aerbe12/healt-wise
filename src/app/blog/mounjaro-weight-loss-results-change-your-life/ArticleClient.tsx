...
function SubHeading({
  ...
  return (
    <p className={`mt-6 font-semibold ${darkMode ? "text-white" : "text-slate-900"}`}>{children} For more context, explore our resources on <Link href="/blog/best-weight-loss-treatment-in-london" className="font-medium text-emerald-600 hover:underline">treatment in London</Link>.</p>
  );
}
          ...
          <div className="min-w-0 max-w-3xl flex-1">
            ...
            >
              ...
              <GuideSection darkMode={darkMode} id="side-effects" heading="Consider Key Side Effects">
                ...
                <p>Mounjaro side effects might feel less intense if you: For more context, explore our resources on <Link href="/blog/best-weight-loss-treatment-in-manchester" className="font-medium text-emerald-600 hover:underline">treatment in Manchester</Link>.</p>
