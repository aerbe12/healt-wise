...
const HERO_IMAGE = `${siteOrigin()}/blog/mounjaro%20weight%20loss%20results.webp`;
...
export default function MounjaroWeightLossResultsPage() {
  const ARTICLE_SCHEMA = {
    ...
    description:
      "What to expect from Mounjaro (tirzepatide) weight loss results: mechanisms, real-world stories, side effects, maintenance after treatment, and professional oversight—informational only, not medical advice.",
    image: [HERO_IMAGE],
