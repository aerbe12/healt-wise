...
export const metadata: Metadata = {
  title:
    "Mounjaro Constipation: Easy Ways to Find Relief (UK Guide) | Health Wise",
  description:
    "Constipation is a common early side effect of Mounjaro. Here's why it happens—and the most effective hydration, fibre, movement, routine, and OTC strategies to ease symptoms.",
  openGraph: {
  ...
  alternates: { canonical: "/mounjaro-constipation-relief-uk" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-constipation-relief-uk",
  },
};
    ...
    >
      <GuideSection id="why-it-happens" heading="Why Mounjaro Causes Constipation">
        ...
        <GuideCallout variant="info">
          ...
          <IL href="/mounjaro-side-effects-uk">
