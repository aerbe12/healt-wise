...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/mounjaro-calorie-cycling-weight-loss" },
};
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-calorie-cycling-weight-loss",
  },
};
    ...
    >
      ...
      <GuideSection id="how-it-works" heading="How It Works with Mounjaro">
        ...
        <GuideParagraph>
          ...
          cause of{" "}
          <IL href="/mounjaro-weight-loss-plateau">weight loss plateaus</IL>.
        </GuideParagraph>
      </GuideSection>
