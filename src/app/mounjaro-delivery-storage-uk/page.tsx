...
export const metadata: Metadata = {
  title:
    "Mounjaro Delivery & Storage UK: Temperature Rules, Safety Checks & What to Do | Health Wise",
  description:
    "Mounjaro must be refrigerated between 2°C and 8°C. Learn how to check your delivery, understand the temperature safety zones, and what to do if your medication arrives warm.",
  openGraph: {
    title:
  ...
  alternates: {
    canonical: "/mounjaro-delivery-storage-uk",
  },
};
...
const REFERENCES = [
  ...
  },
  {
    ...
    href: "/how-we-verify-uk-pharmacies-gphc-safety-standards",
    external: false,
  },
];
...
const SCHEMA = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://health-wise.co.uk/mounjaro-delivery-storage-uk",
  },
};
...
export default function GuideMounjaroStorage() {
  return (
    <GuideLayout
      ...
      toc={TOC}
      internalLinks={internalLinksFor("guideMounjaroStorage")}
    ...
    >
      ...
      <GuideSection id="storage" heading="Storage Requirements">
        ...
        <GuideParagraph>
          ...
          manufacturer, to the{" "}
          <IL href="/how-we-verify-uk-pharmacies-gphc-safety-standards">
            pharmacy
          </IL>
